...
class Session:
    ...
    def __init__(self, remote_address='::1', session_token='', session_lifetime=datetime.timedelta(0,43200), session_type=SESSION_TYPE_USER):
...
class SessionManager:
    ...
    def new_session(self, remote_address='::1', length=128, lifetime=datetime.timedelta(0,43200)):
        while True:
